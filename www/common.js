...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(http) {
        this.http = http;
        this.Login_Url = 'http://www.drivixcorp.com/api/login';
        this.Register_Url = 'http://www.drivixcorp.com/api/register';
    }
    AuthenticationService_1 = AuthenticationService;
    // check Auth or not
    AuthenticationService.check_Auth = function () {
        return AuthenticationService_1.User !== null;
    };
    // Login Function
    AuthenticationService.prototype.Login = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.post(_this.Login_Url, JSON.stringify({}), {
                params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('email', data.email).append('password', data.password),
            })
    ...
    AuthenticationService.prototype.register = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.post(_this.Register_Url, JSON.stringify({}), {
                params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('email', data.email).append('password', data.password).append('name', data.name),
            })
                .subscribe(function (res) {
                resolve(res);
            }, function (err) {
...
var CarsService = /** @class */ (function () {
    function CarsService(http) {
        this.http = http;
        this.storeCarURL = 'http://www.drivixcorp.com/api/storecar';
        this.getUserCarURL = 'http://www.drivixcorp.com/api/getUserCar';
        this.updateCarURL = 'http://www.drivixcorp.com/api/updatecar';
        this.deleteCarURL = 'http://www.drivixcorp.com/api/deletecar';
    }
    // get all user's car list
    CarsService.prototype.getUserCars = function (token) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.post(_this.getUserCarURL, JSON.stringify({}), {
    ...
    // get user's car
    CarsService.prototype.getUserCar = function (token, id) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.post(_this.getUserCarURL, JSON.stringify({}), {
                params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('token', token)
                ...
                var cars;
                cars = res;
                var index = cars.findIndex(function (car) { return car['id'] == id; });
                res = res[index];
                resolve(res);
            }, function (err) {
                reject(err);
    ...
    CarsService.prototype.storeCar = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.post(_this.storeCarURL, JSON.stringify({}), {
    ...
    // get all user's car list
    CarsService.prototype.updateCar = function (token, data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.post(_this.updateCarURL, JSON.stringify({}), {
                params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
                    .set('token', token)
    ...
    // delete user's car
    CarsService.prototype.deleteCar = function (token, carID) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.post(_this.deleteCarURL, JSON.stringify({}), {
                params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
                    .set('token', token)
                    .append('carID', carID)
            })
...
var MapsService = /** @class */ (function () {
    function MapsService(http) {
        this.http = http;
        this.nearestGasStationsURl = 'http://www.drivixcorp.com/api/';
    }
    // get nearest 10 gas stations
    MapsService.prototype.getNearestGasStations = function (location) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.get(_this.nearestGasStationsURl + 'NearestGasStation', {
                params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('long', location.long).append('lat', location.lat),
            })
                .subscribe(function (res) {
                resolve(res);
            }, function (err) {
