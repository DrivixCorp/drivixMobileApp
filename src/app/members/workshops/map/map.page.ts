...
export class MapPage implements OnInit {
  ...
  constructor(public navCtrl: NavController, private workshopsMap: MapsService, private plt: Platform, public modalController: ModalController,
  ...
  // get nearest workshops and set markers
  getMarkers() {
    this.geolocation.getCurrentPosition().then((resp) => {
      this.currentLocation = { lat: resp.coords.latitude, long: resp.coords.longitude };
      this.workshopsMap.getNearestWorkshops(this.currentLocation, '')
          .then(async success => {
        ...
        const actionSheet = await this.actionSheetController.create({
          buttons: [{
            ...
            handler: () => {
              ...
              this.router.navigate(['/members/workshop', stationMarker]);
            }
          }, {
            text: 'Cancel',
            icon: 'close',
